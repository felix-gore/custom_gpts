# Instructivo Concurso de Vinculación con la Comunidad 8% 2025
...
ID: DOC-GORENUBLE-CONCURSO8-2025-PRIVADOS-PARTICIPACION-01
...
### 1.6. Descripción de Fondos Disponibles
...
- Cpt: Lista-de-Documentos-Obligatorios
  ...
  - ID: DOC-GORENUBLE-CONCURSO8-2025-PRIVADOS-ADMISIBILIDAD-LISTA-01
    ...
    - Req: Declaración jurada sobre restricciones (letras b y c).
...
ID: DOC-GORENUBLE-CONCURSO8-2025-PRIVADOS-CONSULTAS-01
...
ID: DOC-GORENUBLE-CONCURSO8-2025-PRIVADOS-RESTRICCIONES-01
  ...
  - Cpt: Pauta-de-Evaluación-Técnica
    ...
    - Cpt: Criterio-5-Estrategia-Difusión
      ...
      - Cpt: Nivel-5.3
        ...
        - Val: 10 puntos.
      - Cpt: Nivel-5.4
        - Def: La estrategia de difusión presenta mayores errores o no contiene la información solicitada y/o no se encuentra entre los porcentajes solicitados.
        - Val: 5 puntos.
      - Cpt: Nivel-5.5
...
ID: DOC-GORENUBLE-CONCURSO8-2025-CULTURA-AREAS-MONTOS-01
...
- Obj: Contribuir al fortalecimiento del tejido social y a la mejora de la calidad de vida comunitaria.
...
ID: DOC-GORENUBLE-CONCURSO8-2025-MAYORES-AREAS-MONTOS-01

- Cpt: Postulantes-Exclusivos
  - Def: Clubes de adulto mayor, Uniones Comunales, Federaciones y Confederaciones de Adulto Mayor.
- Cpt: Monto-Máximo-General
  - Def: $2.500.000 para todas las áreas.
- Cpt: Tabla-de-Áreas-de-Postulación
  - ID: DOC-GORENUBLE-CONCURSO8-2025-MAYORES-AREAS-TABLA-01

    |Área|Definición|
    |-|-|
    |Social Adulto Mayor|- Purp: Desarrollar talleres y actividades de cuidado, autocuidado o autovalencia para la prevención del deterioro físico-cognitivo. - Ex: Capacitaciones, operativos de salud, talleres de estimulación cognitiva, terapias alternativas, viajes terapéuticos, talleres de cocina saludable. - Ctx: Si el adulto mayor tiene dependencia severa, se puede incorporar al cuidador en las actividades. - Req: La compra de equipamiento debe estar acompañada de actividades atingentes.|
    |Deporte Adulto Mayor|- Purp: Desarrollar talleres para el envejecimiento activo y actividades al aire libre. - Ex: Talleres de Yoga/Reiki, baile entretenido, caminatas, gimnasia, olimpiadas, taller de acondicionamiento físico.|
    |Cultura Adulto Mayor|- Purp: Desarrollar actividades de recreación, esparcimiento o educación cultural. - Ex: Viajes a rutas patrimoniales, talleres de música/danza, talleres de manualidades, presentaciones artísticas, talleres literarios, talleres de artesanías ancestrales, ferias y exposiciones.|

- Warn: Las organizaciones de adulto mayor no podrán postular a otros Fondos del concurso.

## 8. Fondo de Medio Ambiente

ID: DOC-GORENUBLE-CONCURSO8-2025-PRIVADOS-FONDO-AMBIENTE-01

### 8.1. Objetivo y Participantes

ID: DOC-GORENUBLE-CONCURSO8-2025-AMBIENTE-OBJ-PART-01

- Obj: Promover e incentivar iniciativas para el cuidado y protección del medio ambiente, fomentando la educación ambiental, el desarrollo sustentable y la tenencia responsable de mascotas.
- Cpt: Participantes
  - Req: Instituciones privadas sin fines de lucro, organizaciones de la sociedad civil y comunitarias.
...
ID: DOC-GORENUBLE-CONCURSO8-2025-AMBIENTE-PRESUPUESTO-01

- Cpt: Monto-Total-Fondo
  - Def: $400.000.000.
- Cpt: Asignación-Especial
  - Ctx: $25.000.000 se destinarán a "Habilitación de senderos comunitarios sostenibles" dentro del área de Biodiversidad y Desarrollo Sustentable.

### 8.3. Gastos Financiables (Fondo Medio Ambiente)

ID: DOC-GORENUBLE-CONCURSO8-2025-AMBIENTE-GASTOS-01

- Cpt: Tabla-de-Gastos-Específicos
  - ID: DOC-GORENUBLE-CONCURSO8-2025-AMBIENTE-GASTOS-TABLA-01
    ...
    |Difusión|- Req: Obligatorio, 3-10% del presupuesto.|- Ex: Medios escritos, radio, TV. Artículos como lápices, bolsas, etc. - Req: Deben ser de material reciclable. - Req: Debe incluir logo GORE, nombre proyecto y fuente de financiamiento.|
...
ID: DOC-GORENUBLE-CONCURSO8-2025-SEGURIDAD-PRESUPUESTO-01
...
- Cpt: Áreas-Fondo-de-Seguridad-Ciudadana
...
### 10.5. Reglas, Restricciones y Evaluación (Municipalidades)
...
- Cpt: Articulo-13-14-15
  - Proc: Observaciones a la rendición serán informadas por correo. La organización tiene 5 días hábiles para subsanar. Si la respuesta no es satisfactoria, el gasto será rechazado y se deberá reintegrar el monto.
- Cpt: Articulo-17
  - Cpt: Apelación
    - Ctx: Como instancia final y excepcional, la institución puede apelar al resultado de la evaluación mediante carta al Gobernador. Una comisión de análisis emitirá un veredicto final.
- Cpt: Articulo-21-22-23
  - Cpt: Término-de-Convenio-y-Sanciones
    - Ctx: El GORE puede poner término anticipado al convenio y exigir el reintegro de los recursos por incumplimientos.
    - Ctx: Si la rendición es insatisfactoria, los antecedentes se remitirán a Asesoría Jurídica para el posible cobro de garantías y acciones legales.
    - Cpt: Inhabilitación
      - Def: El incumplimiento puede configurar causal de inhabilitación para futuras postulaciones.
      - Ctx: 2 años por primera vez, 5 años por reincidencia. [cite: 1339]
    - Warn: Gastos rechazados o no ejecutados deben ser restituidos al GORE.

## 12. Anexos (Formularios y Documentos Tipo)

ID: DOC-GORENUBLE-CONCURSO8-2025-ANEXOS-MASTER-01
Purp: Proporcionar los formularios y documentos estandarizados requeridos para el proceso de postulación y rendición de cuentas del Concurso de Vinculación con la Comunidad 8% 2025.

### Anexo 1: Formulario de Postulación (Instituciones Privadas)

ID: DOC-GORENUBLE-CONCURSO8-2025-ANX-FORM-POST-PRIVADOS-01

BEGIN_EMBEDDED_BLOCK:: GUIDE-SFD-STS-MASTER-01 FORM-POST-PRIVADOS-MASTER-01

```plaintext
# Formulario de Postulación: Concurso Vinculación con la Comunidad 8% 2025 (Instituciones Privadas)

ID: FORM-POST-PRIVADOS-MASTER-01
Version: 1.0.0
Status: Published
...
ID: FORM-POST-PRIVADOS-S1-ORG-ID-01

#### Nombre de la Organización

ID: FORM-POST-PRIVADOS-S1-ORG-NOMBRE-01
...
ID: FORM-POST-PRIVADOS-S1-ORG-RUT-01
...
ID: FORM-POST-PRIVADOS-S1-ORG-DOMICILIO-01
...
ID: FORM-POST-PRIVADOS-S1-ORG-COMUNA-01
Field-Label: "Comuna"
Field-Type: Select
Field-Constraint: "Req: mandatory."

- Field-Option: "Bulnes"
- Field-Option: "Chillán"
- Field-Option: "Chillán Viejo"
- Field-Option: "Cobquecura"
- Field-Option: "Coelemu"
- Field-Option: "Coihueco"
- Field-Option: "El Carmen"
- Field-Option: "Ninhue"
- Field-Option: "Ñiquén"
- Field-Option: "Pemuco"
- Field-Option: "Pinto"
- Field-Option: "Portezuelo"
- Field-Option: "Quillón"
- Field-Option: "Quirihue"
- Field-Option: "Ránquil"
- Field-Option: "San Carlos"
- Field-Option: "San Fabián"
- Field-Option: "San Ignacio"
- Field-Option: "San Nicolás"
- Field-Option: "Treguaco"
- Field-Option: "Yungay"

#### Teléfono de Contacto

ID: FORM-POST-PRIVADOS-S1-ORG-TELEFONO-01
...
ID: FORM-POST-PRIVADOS-S1-ORG-EMAIL-01
...
ID: FORM-POST-PRIVADOS-S1-REP-LEGAL-NOMBRE-01
...
ID: FORM-POST-PRIVADOS-S1-REP-LEGAL-RUT-01
...
ID: FORM-POST-PRIVADOS-S1-REP-LEGAL-TELEFONO-01
...
ID: FORM-POST-PRIVADOS-S1-REP-LEGAL-EMAIL-01
...
ID: FORM-POST-PRIVADOS-S2-INICIATIVA-ID-01

#### Nombre de la Iniciativa

ID: FORM-POST-PRIVADOS-S2-INICIATIVA-NOMBRE-01
...
ID: FORM-POST-PRIVADOS-S2-INICIATIVA-FONDO-01
Field-Label: "Fondo al que Postula"
Field-Type: Select
Field-Constraint: "Req: mandatory."

- Field-Option: "Cultura"
- Field-Option: "Deporte"
- Field-Option: "Social e Inclusión"
- Field-Option: "Seguridad Ciudadana"
- Field-Option: "Medio Ambiente"
- Field-Option: "Adulto Mayor"
- Field-Option: "Equidad de Género"

#### Área de Postulación

ID: FORM-POST-PRIVADOS-S2-INICIATIVA-AREA-01
...
ID: FORM-POST-PRIVADOS-S2-INICIATIVA-MONTO-01
...
ID: FORM-POST-PRIVADOS-S2-INICIATIVA-APORTE-TERCEROS-01
...
ID: FORM-POST-PRIVADOS-S2-INICIATIVA-APORTE-PROPIO-01
...
ID: FORM-POST-PRIVADOS-S2-INICIativa-COSTO-TOTAL-01
Field-Label: "Costo Total de la Iniciativa"
Field-Type: Number
Field-Constraint: "Req: mandatory. Min-Val: 0."
Field-Logic: "Cond: (Value == Ref: FORM-POST-PRIVADOS-S2-INICIATIVA-MONTO-01.Value + Ref: FORM-POST-PRIVADOS-S2-INICIATIVA-APORTE-TERCEROS-01.Value + Ref: FORM-POST-PRIVADOS-S2-INICIATIVA-APORTE-PROPIO-01.Value) -> Validation: pass."

### Sección 3: Descripción de la Iniciativa

ID: FORM-POST-PRIVADOS-S3-INICIATIVA-DESC-01

#### Fundamentación

ID: FORM-POST-PRIVADOS-S3-FUNDAMENTACION-01
...
ID: FORM-POST-PRIVADOS-S3-DESCRIPCION-01
...
ID: FORM-POST-PRIVADOS-S3-OBJ-GENERAL-01
...
ID: FORM-POST-PRIVADOS-S3-OBJ-ESPECIFICOS-01
...
ID: FORM-POST-PRIVADOS-S3-BEN-DIRECTOS-01
...
ID: FORM-POST-PRIVADOS-S3-BEN-INDIRECTOS-01
...
ID: FORM-POST-PRIVADOS-S3-BEN-DESC-01
...
ID: FORM-POST-PRIVADOS-S4-PLAN-TRABAJO-01
Field-Instr: "Detallar las actividades a realizar y el cronograma de ejecución en meses."

#### Tabla de Plan de Trabajo

ID: FORM-POST-PRIVADOS-S4-PLAN-TABLA-01
Field-Label: "Plan de Trabajo"
Field-Type: Repeater
Field-Constraint: "Req: mandatory."

- Field-Group: "Fila de Actividad"

  - #### Actividad

  - ID: FORM-POST-PRIVADOS-S4-ACTIVIDAD-01
  - Field-Type: Text

  - #### Mes 1

  - ID: FORM-POST-PRIVADOS-S4-MES1-01
  - Field-Type: Checkbox

  - #### Mes 2

  - ID: FORM-POST-PRIVADOS-S4-MES2-01
  - Field-Type: Checkbox

  - #### Mes 3

  - ID: FORM-POST-PRIVADOS-S4-MES3-01
  - Field-Type: Checkbox

  - #### Mes 4

  - ID: FORM-POST-PRIVADOS-S4-MES4-01
  - Field-Type: Checkbox

  - #### Mes 5

  - ID: FORM-POST-PRIVADOS-S4-MES5-01
  - Field-Type: Checkbox

  - #### Mes 6

  - ID: FORM-POST-PRIVADOS-S4-MES6-01
  - Field-Type: Checkbox

  - #### Mes 7

  - ID: FORM-POST-PRIVADOS-S4-MES7-01
  - Field-Type: Checkbox

  - #### Mes 8

  - ID: FORM-POST-PRIVADOS-S4-MES8-01
  - Field-Type: Checkbox

### Sección 5: Presupuesto Detallado

ID: FORM-POST-PRIVADOS-S5-PRESUPUESTO-01
Field-Instr: "Detallar todos los gastos en los ítems correspondientes. Los montos deben coincidir con lo solicitado."

#### Ítem: Honorarios

ID: FORM-POST-PRIVADOS-S5-HONORARIOS-01
Field-Label: "Ítem 1: Honorarios"
Field-Type: Repeater

- Field-Group: "Fila de Gasto Honorario"

  - #### Detalle del Gasto

  - ID: FORM-POST-PRIVADOS-S5-HON-DETALLE-01
  - Field-Type: Text
  - Field-Instr: "Ej: Monitor de taller, Profesional de apoyo."

  - #### Monto Solicitado

  - ID: FORM-POST-PRIVADOS-S5-HON-MONTO-01
  - Field-Type: Number

#### Ítem: Equipamiento

ID: FORM-POST-PRIVADOS-S5-EQUIPAMIENTO-01
Field-Label: "Ítem 2: Equipamiento"
Field-Type: Repeater

- Field-Group: "Fila de Gasto Equipamiento"

  - #### Detalle del Gasto

  - ID: FORM-POST-PRIVADOS-S5-EQUIP-DETALLE-01
  - Field-Type: Text
  - Field-Instr: "Ej: Data show, notebook, indumentaria."

  - #### Monto Solicitado

  - ID: FORM-POST-PRIVADOS-S5-EQUIP-MONTO-01
  - Field-Type: Number

#### Ítem: Gestión y Producción

ID: FORM-POST-PRIVADOS-S5-GESTION-01
Field-Label: "Ítem 3: Gastos de Gestión y Producción"
Field-Type: Repeater

- Field-Group: "Fila de Gasto Gestión"

  - #### Detalle del Gasto

  - ID: FORM-POST-PRIVADOS-S5-GEST-DETALLE-01
  - Field-Type: Text
  - Field-Instr: "Ej: Arriendo de local, alimentación, materiales."

  - #### Monto Solicitado

  - ID: FORM-POST-PRIVADOS-S5-GEST-MONTO-01
  - Field-Type: Number

#### Ítem: Difusión

ID: FORM-POST-PRIVADOS-S5-DIFUSION-01
Field-Label: "Ítem 4: Gastos de Difusión"
Field-Type: Repeater

- Field-Group: "Fila de Gasto Difusión"

  - #### Detalle del Gasto

  - ID: FORM-POST-PRIVADOS-S5-DIFU-DETALLE-01
  - Field-Type: Text
  - Field-Instr: "Ej: Pendón, volantes, spot radial."

  - #### Monto Solicitado

  - ID: FORM-POST-PRIVADOS-S5-DIFU-MONTO-01
  - Field-Type: Number
```

END_EMBEDDED_BLOCK:: FORM-POST-PRIVADOS-MASTER-01

### Anexo 2: Formulario de Postulación (Municipalidades)

ID: DOC-GORENUBLE-CONCURSO8-2025-ANX-FORM-POST-PUBLICOS-01

BEGIN_EMBEDDED_BLOCK:: GUIDE-SFD-STS-MASTER-01 FORM-POST-PUBLICOS-MASTER-01

```plaintext
# Formulario de Postulación: Concurso Vinculación con la Comunidad 8% 2025 (Organismos Públicos - Municipalidades)

ID: FORM-POST-PUBLICOS-MASTER-01
Version: 1.0.0
Status: Published
Ref-SFD-Guide: GUIDE-SFD-STS-MASTER-01
...
ID: FORM-POST-PUBLICOS-S1-MUNI-ID-01

#### Nombre del Municipio

ID: FORM-POST-PUBLICOS-S1-MUNI-NOMBRE-01
...
ID: FORM-POST-PUBLICOS-S1-MUNI-RUT-01
...
ID: FORM-POST-PUBLICOS-S1-MUNI-DOMICILIO-01
...
ID: FORM-POST-PUBLICOS-S1-ALCALDE-NOMBRE-01
...
ID: FORM-POST-PUBLICOS-S1-ALCALDE-RUT-01
...
ID: FORM-POST-PUBLICOS-S1-PROF-RESP-NOMBRE-01
...
ID: FORM-POST-PUBLICOS-S1-PROF-RESP-EMAIL-01
...
ID: FORM-POST-PUBLICOS-S1-PROF-RESP-TELEFONO-01
...
ID: FORM-POST-PUBLICOS-S2-INICIATIVA-ID-01

#### Nombre de la Iniciativa

ID: FORM-POST-PUBLICOS-S2-INICIATIVA-NOMBRE-01
Field-Label: "Nombre de la Iniciativa"
Field-Type: Text
Field-Constraint: "Req: mandatory."
...
ID: FORM-POST-PUBLICOS-S2-INICIATIVA-FONDO-01
Field-Label: "Fondo al que Postula"
Field-Type: Select
Field-Constraint: "Req: mandatory."

- Field-Option: "Fomento a la Cultura"
- Field-Option: "Seguridad Ciudadana"

#### Área de Postulación

ID: FORM-POST-PUBLICOS-S2-INICIATIVA-AREA-01
Field-Label: "Área de Postulación"
Field-Type: Text
Field-Constraint: "Req: mandatory."
...
ID: FORM-POST-PUBLICOS-S2-INICIATIVA-MONTO-01
...
ID: FORM-POST-PUBLICOS-S2-INICIATIVA-COSTO-TOTAL-01
Field-Label: "Costo Total de la Iniciativa"
Field-Type: Number
Field-Constraint: "Req: mandatory. Min-Val: 0."
...
ID: FORM-POST-PUBLICOS-S3-DESC-PRESUPUESTO-01
Field-Instr: "Esta sección es idéntica en estructura a las secciones 3, 4 y 5 del formulario para privados."

- Ref: FORM-POST-PRIVADOS-S3-INICIATIVA-DESC-01
- Ref: FORM-POST-PRIVADOS-S4-PLAN-TRABAJO-01
- Ref: FORM-POST-PRIVADOS-S5-PRESUPUESTO-01
- Ctx: El plazo de ejecución del plan de trabajo es de 9 meses en lugar de 8.
```

END_EMBEDDED_BLOCK:: FORM-POST-PUBLICOS-MASTER-01

### Anexo 3: Carta Solicitud de Recursos

ID: DOC-GORENUBLE-CONCURSO8-2025-ANX-FORM-SOLICITUD-01

BEGIN_EMBEDDED_BLOCK:: GUIDE-SFD-STS-MASTER-01 ANX-FORM-SOLICITUD-01

```plaintext
# Formulario: Carta Solicitud de Recursos

ID: FORM-SOLICITUD-RECURSOS-01
Version: 1.0.0
Status: Published
Ref-SFD-Guide: GUIDE-SFD-STS-MASTER-01
...
ID: FORM-SOLICITUD-S1-HEADER-01

#### Comuna

ID: FORM-SOLICITUD-S1-COMUNA-01
Field-Label: "Comuna"
Field-Type: Text
Field-Constraint: "Req: mandatory."
...
ID: FORM-SOLICITUD-S2-BODY-01

#### Nombre Representante Legal

ID: FORM-SOLICITUD-S2-REP-LEGAL-01
Field-Label: "Yo,"
Field-Type: Text
Field-Constraint: "Req: mandatory."
...
ID: FORM-SOLICITUD-S2-INSTITUCION-01
...
ID: FORM-SOLICITUD-S2-DOMICILIO-01
...
ID: FORM-SOLICITUD-S2-COMUNA-DOM-01
Field-Label: "comuna de"
Field-Type: Text
Field-Constraint: "Req: mandatory."

#### Texto Fijo de Solicitud

ID: FORM-SOLICITUD-S2-TEXTO-FIJO-01
Field-Label: "Solicito al Sr. Óscar Crisóstomo Llanos, Gobernador de la Región de Ñuble, financiamiento para el proyecto denominado"
Field-Type: Static-Text

#### Nombre del Proyecto

ID: FORM-SOLICITUD-S2-PROYECTO-NOMBRE-01
Field-Label: ""
Field-Type: Text
Field-Constraint: "Req: mandatory."
...
ID: FORM-SOLICITUD-S2-MONTO-01
Field-Label: "por el monto de $"
Field-Type: Number
Field-Constraint: "Req: mandatory."

#### Fondo Postulado

ID: FORM-SOLICITUD-S2-FONDO-01
Field-Label: "postulado al fondo de"
Field-Type: Text
Field-Constraint: "Req: mandatory."

#### Lineamiento

ID: FORM-SOLICITUD-S2-LINEAMIENTO-01
Field-Label: "lineamiento de"
Field-Type: Text
Field-Constraint: "Req: optional."

#### Texto Fijo Concurso

ID: FORM-SOLICITUD-S2-TEXTO-CONCURSO-01
Field-Label: "del "CONCURSO DE VINCULACIÓN CON LA COMUNIDAD 8% 2025"."
Field-Type: Static-Text

### Sección 3: Cierre y Firma

ID: FORM-SOLICITUD-S3-CIERRE-01

#### Firma

ID: FORM-SOLICITUD-S3-FIRMA-01
Field-Label: "FIRMA Y TIMBRE DEL REPRESENTANTE LEGAL"
Field-Type: Static-Text
Field-Instr: "Se debe firmar y timbrar por el representante legal."
```

END_EMBEDDED_BLOCK:: ANX-FORM-SOLICITUD-01

### Anexo 4: Carta de Aceptación de Términos y Condiciones

ID: DOC-GORENUBLE-CONCURSO8-2025-ANX-FORM-ACEPTACION-01

BEGIN_EMBEDDED_BLOCK:: GUIDE-SFD-STS-MASTER-01 ANX-FORM-ACEPTACION-01

```plaintext
# Formulario: Carta de Aceptación de Términos y Condiciones

ID: FORM-ACEPTACION-TERMINOS-01
Version: 1.0.0
Status: Published
Ref-SFD-Guide: GUIDE-SFD-STS-MASTER-01
...
ID: FORM-ACEPTACION-S1-ID-01

#### Nombre Representante Legal

ID: FORM-ACEPTACION-S1-REP-LEGAL-01
Field-Label: "Yo,"
Field-Type: Text
Field-Constraint: "Req: mandatory."
...
ID: FORM-ACEPTACION-S1-INSTITUCION-01
...
ID: FORM-ACEPTACION-S2-DECLARACION-01

#### Texto Declaración

ID: FORM-ACEPTACION-S2-TEXTO-01
Field-Label: "Declaro, conocer y aceptar el contenido íntegro del presente instructivo general y sus anexos, además de aceptar la normativa legal y reglamentaria vigente."
Field-Type: Static-Text
```

END_EMBEDDED_BLOCK:: ANX-FORM-ACEPTACION-01

### Anexo 5: Carta de Presentación y Experiencia de la Organización

ID: DOC-GORENUBLE-CONCURSO8-2025-ANX-FORM-PRESENTACION-01

BEGIN_EMBEDDED_BLOCK:: GUIDE-SFD-STS-MASTER-01 ANX-FORM-PRESENTACION-PRIVADOS-01

```plaintext
# Formulario: Carta de Presentación y Experiencia de la Organización

ID: FORM-PRESENTACION-EXPERIENCIA-01
Version: 1.0.0
Status: Published
Ref-SFD-Guide: GUIDE-SFD-STS-MASTER-01
...
ID: FORM-PRESENTACION-EXP-NOMBRE-01
Field-Label: "Nombre de la organización"
Field-Type: Text
Field-Constraint: "Req: mandatory."
...
ID: FORM-PRESENTACION-EXP-RUT-01
Field-Label: "Rut de la Organización"
Field-Type: Text
Field-Constraint: "Req: mandatory."
...
ID: FORM-PRESENTACION-EXP-DIRECCION-01
...
ID: FORM-PRESENTACION-EXP-OBJETIVOS-01
...
ID: FORM-PRESENTACION-EXP-EXPERIENCIA-01
...
ID: FORM-PRESENTACION-EXP-DECLARACION-01
Field-Label: "El o la representante legal declara tener experiencia en el ámbito de postulación y ejecución del proyecto a presentar al Concurso de Vinculación con la Comunidad 8%"
Field-Type: Static-Text

#### Nombre Representante Legal

ID: FORM-PRESENTACION-EXP-REP-NOMBRE-01
...
ID: FORM-PRESENTACION-EXP-REP-RUT-01
Field-Label: "RUT"
Field-Type: Text
Field-Constraint: "Req: mandatory."
```

END_EMBEDDED_BLOCK:: ANX-FORM-PRESENTACION-PRIVADOS-01

### Anexo 6: Declaración Jurada Simple A (Restricciones B y C)

ID: DOC-GORENUBLE-CONCURSO8-2025-ANX-FORM-DJ-A-01

BEGIN_EMBEDDED_BLOCK:: GUIDE-SFD-STS-MASTER-01 ANX-FORM-DJ-A-01

```plaintext
# Formulario: Declaración Jurada Simple A (Restricciones B y C)

ID: FORM-DJ-A-RESTRICCIONES-BC-01
Purp: Declarar el cumplimiento de las restricciones de las letras B y C del instructivo.

#### Cuerpo de la Declaración

ID: FORM-DJ-A-BODY-01
Field-Label: "Declaro; Que la Institución cumple con lo establecido en las letras B y C "DE LAS RESTRICCIONES DEL FONDO Y LOS GASTOS NO FINANCIABLES". Acepto la anulación absoluta de mi postulación en el evento de comprobarse la falsedad de alguno de los antecedentes presentados."
Field-Type: Static-Text
Field-Instr: "Requiere identificación de la comuna, fecha, nombre y RUT del representante legal, y firma/timbre."
```

END_EMBEDDED_BLOCK:: ANX-FORM-DJ-A-01

### Anexo 7: Declaración Jurada Simple B (Restricción M)

ID: DOC-GORENUBLE-CONCURSO8-2025-ANX-FORM-DJ-B-01

BEGIN_EMBEDDED_BLOCK:: GUIDE-SFD-STS-MASTER-01 ANX-FORM-DJ-B-01

```plaintext
# Formulario: Declaración Jurada Simple B (Restricción M)

ID: FORM-DJ-B-RESTRICCION-M-01
Purp: Declarar el cumplimiento de la restricción de la letra M del instructivo.

#### Cuerpo de la Declaración

ID: FORM-DJ-B-BODY-01
Field-Label: "Declaro; Que la Institución cumple con lo establecido en la letra m) "DE LAS RESTRICCIONES DEL FONDO Y LOS GASTOS NO FINANCIABLES". Acepto la anulación absoluta de mi postulación en el evento de comprobarse la falsedad de alguno de los antecedentes presentados."
Field-Type: Static-Text
Field-Instr: "Requiere identificación de la comuna, fecha, nombre y RUT del representante legal, y firma/timbre."
```

END_EMBEDDED_BLOCK:: ANX-FORM-DJ-B-01

### Anexo 8: Carta de Compromiso (Prevención)

ID: DOC-GORENUBLE-CONCURSO8-2025-ANX-FORM-COMPROMISO-01

BEGIN_EMBEDDED_BLOCK:: GUIDE-SFD-STS-MASTER-01 ANX-FORM-COMPROMISO-01

```plaintext
# Formulario: Carta de Compromiso (Prevención)

ID: FORM-COMPROMISO-PREVENCION-01
Purp: Comprometer a la organización a prevenir actos de violencia y consumo de alcohol/drogas.

#### Cuerpo de la Declaración

ID: FORM-COMPROMISO-BODY-01
Field-Label: "Declaro que la organización que represento se compromete a generar todas las acciones que sean necesarias para prevenir actos de violencia, consumo de alcohol y drogas en recintos que se ejecuten actividades con recursos obtenidos por la subvención del "CONCURSO DE VINCULACIÓN CON LA COMUNIDAD 8% 2025""
Field-Type: Static-Text
Field-Instr: "Requiere identificación de la comuna, fecha, nombre y RUT del representante legal, y firma/timbre."
```

END_EMBEDDED_BLOCK:: ANX-FORM-COMPROMISO-01
